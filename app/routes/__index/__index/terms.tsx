  ...
  return (
    <div className="min-h-[80vh]">
      <section id="hero" className="bg-gray-200">
        <div className="container max-w-screen-lg flex items-center justify-center py-32 -mt-20">
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-slate-800">
            📝 Terms
          </h1>
        </div>
      </section>
      <section id="content" className="container -mt-20 pb-20">
        <div className="mx-auto prose prose-slate lg:prose-xl bg-white p-6 md:p-12 rounded-lg">
          <h2>OVERVIEW</h2>
          <p>
            This website is operated by DesignedWithAi. Throughout the site, the
            terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo; refer
            to DesignedWithAi. DesignedWithAi offers this website, including all
          ...
          <p>
            ...
            our Return Policy. We adhere to Printful&rsquo;s Return Policy,
            which can be found{" "}
            <a href="https://www.printful.com/policies/returns">here</a>
          </p>
          <p>
          ...
          <p>
            ...
            <a href="https://www.printful.com/policies/returns">
              Returns Policy
            </a>
            .
          </p>
          ...
          <p>
            DesignedWithAi uses the OpenAi API. You agree to adhere to their
            Terms of Use, which can be found{" "}
            <a href="https://openai.com/api/policies/terms">here</a>.
          </p>
          <p>
          ...
          <p>
            In no case shall DesignedWithAi, our directors, officers, employees,
          ...
          <p>
            You agree to indemnify, defend and hold harmless DesignedWithAi and
          ...
          <p>DesignedWithAi</p>
          <p>PO BOX 778, Candler, NC 28715</p>
        </div>
      </section>
    </div>
  );
