  ...
  return (
    <div className="min-h-[80vh]">
      <section id="hero" className="bg-gray-200">
        <div className="container flex items-center justify-center max-w-screen-lg py-32 -mt-20">
      ...
      <section id="content" className="container -mt-20 pb-20">
        <div className="mx-auto prose prose-slate lg:prose-xl bg-white p-6 md:p-12 rounded-lg">
          <p>
            This Privacy Policy describes how DesignedWithAI (the “Site” or
          ...
          <ul>
            <li>
              We use Open AI to power our designs. You can read more about how
              Open AI uses your Personal Information here:{" "}
              <a
          ...
          <p>
            We <i>DO NOT</i>&nbsp;engage in fully automated decision-making that
          ...
          <p>
            ...
            us through the contact information below<i>.</i>
          </p>
          <h2>CCPA</h2>
          <p>
          ...
          <p>
            ...
            us by e-mail at hey@designedwithai.com&nbsp;or by mail using the
            details provided below:
          </p>
          <p>PO BOX 778, Candler, NC 28715</p>
          <i>
            <i>Last updated: 11/25/2022</i>
          </i>
          <p>
